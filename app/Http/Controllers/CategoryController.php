...
class CategoryController extends Controller
{
    ...
    {
        $categoriesWithArticales = Category::with('articales')->paginate(15);
        return response()->json([
            "categoriesWithArticales" => $categoriesWithArticales
        ]);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    // 4. The category view contains paginated newest articles.
